...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Widget::*)()>(_a, &Widget::hoverEntered, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Widget::*)()>(_a, &Widget::hoverLeft, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Widget::*)()>(_a, &Widget::clicked, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Widget::*)()>(_a, &Widget::doubleClicked, 3))
            return;
    }
}
...
// SIGNAL 0
void Widget::hoverEntered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Widget::hoverLeft()
{
